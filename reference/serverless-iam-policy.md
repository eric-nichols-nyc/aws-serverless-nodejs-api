...
Replace `834512928834` with your AWS Account ID (e.g. `123456789`) which you can find under [AWS IAM](https://console.aws.amazon.com/iam/) in the console.
...
```json
{
    ...
    "Statement": [
        ...
        },
        {
            ...
            "Resource": [
                "arn:aws:cloudformation:*:834512928834:stack/serverless-*"
            ]
        },
        {
            "Effect": "Allow",
        ...
        },
        {
            ...
            "Resource": [
                "arn:aws:lambda:*:834512928834:function:serverless-*"
            ]
        },
        {
            "Effect": "Allow",
        ...
        },
        {
            ...
            "Resource": [
                "arn:aws:events:*:834512928834:rule/serverless-*"
            ]
        },
        {
            "Effect": "Allow",
        ...
        },
        {
            ...
            "Resource": [
                "arn:aws:iam::834512928834:role/serverless-*"
            ]
        },
        {
            "Effect": "Allow",
